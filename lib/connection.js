...
export async function start() {
    ...
    sock = makeWASocket({
        ...
        // Cambiado de Edge a Chrome para evitar que WhatsApp bloquee la petición
    ...
    // Variable de control para pedir el código una sola vez
    let pairingCodeRequested = false

    sock.ev.on('connection.update', async (update) => {
        const { connection, lastDisconnect, qr } = update

        // Disparamos la petición del código SOLO cuando el socket emite 'qr' (confirmación de que está abierto y listo)
