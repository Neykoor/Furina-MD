import { getOrCreateUser, updateUser, addExp, checkCooldown, formatMoney } from '../users.js'
...
export const MINERALES = {
    ...
    hierro:     { id: 'hierro',     nombre: 'Hierro',        emoji: '⚙️', rareza: 'comun',     valor: 40,  exp: 7,  nivel: 2,  probabilidad: 25 },
    ...
    meteorito:  { id: 'meteorito',  nombre: 'Meteorito',     emoji: '☄️', rareza: 'legendario',valor: 2500,exp: 200,nivel: 30, probabilidad: 0.2 },
}
...
export const PECES = {
    ...
    pez_espada:    { id: 'pez_espada',    nombre: 'Pez Espada',     emoji: '🗡️', rareza: 'poco_comun',valor: 70,  exp: 12, nivel: 5,  probabilidad: 12 },
...
export const ANIMALES = {
    conejo:      { id: 'conejo',      nombre: 'Conejo',        emoji: '🐰', rareza: 'comun',     valor: 20,  exp: 5,  nivel: 1,  probabilidad: 30, vida: 20, danio: 5 },
    zorro:       { id: 'zorro',       nombre: 'Zorro',         emoji: '🦊', rareza: 'comun',     valor: 35,  exp: 7,  nivel: 2,  probabilidad: 25, vida: 35, danio: 8 },
    ciervo:      { id: 'ciervo',      nombre: 'Ciervo',        emoji: '🦌', rareza: 'comun',     valor: 50,  exp: 10, nivel: 3,  probabilidad: 20, vida: 50, danio: 10 },
    jabali:      { id: 'jabali',      nombre: 'Jabalí',        emoji: '🐗', rareza: 'poco_comun',valor: 80,  exp: 15, nivel: 5,  probabilidad: 15, vida: 80, danio: 15 },
    lobo:        { id: 'lobo',        nombre: 'Lobo',          emoji: '🐺', rareza: 'poco_comun',valor: 100, exp: 18, nivel: 7,  probabilidad: 10, vida: 100, danio: 20 },
    oso:         { id: 'oso',         nombre: 'Oso',           emoji: '🐻', rareza: 'raro',      valor: 200, exp: 30, nivel: 10, probabilidad: 6,  vida: 150, danio: 30 },
    puma:        { id: 'puma',        nombre: 'Puma',          emoji: '🐆', rareza: 'raro',      valor: 250, exp: 35, nivel: 12, probabilidad: 4,  vida: 180, danio: 35 },
    alce:        { id: 'alce',        nombre: 'Alce',          emoji: '🫎', rareza: 'epico',     valor: 400, exp: 50, nivel: 15, probabilidad: 2,  vida: 250, danio: 45 },
    rinoceronte: { id: 'rinoceronte', nombre: 'Rinoceronte',   emoji: '🦏', rareza: 'epico',     valor: 600, exp: 70, nivel: 18, probabilidad: 1,  vida: 350, danio: 55 },
    dragon:      { id: 'dragon',      nombre: 'Dragón',        emoji: '🐲', rareza: 'legendario',valor: 3000,exp: 250,nivel: 30, probabilidad: 0.3, vida: 500, danio: 80 },
    fenix:       { id: 'fenix',       nombre: 'Fénix',         emoji: '🔥', rareza: 'mitico',    valor: 8000,exp: 500,nivel: 40, probabilidad: 0.1, vida: 800, danio: 120 },
}
...
export const MATERIALES_TALAR = {
    madera:        MATERIALES.madera,
    corteza:       MATERIALES.corteza,
    fibra:         MATERIALES.fibra,
    resina:        MATERIALES.resina,
    madera_magica: MATERIALES.madera_magica,
}
...
export const RECETAS_CRAFTEO = {
    ...
    pico_hierro: {
        id: 'pico_hierro', nombre: 'Pico de Hierro', emoji: '⛏️', tipo: 'herramienta',
    ...
    cana_basica: {
        id: 'cana_basica', nombre: 'Caña Básica', emoji: '🎣', tipo: 'herramienta',
        requiere: { madera: 15, fibra: 10 }, valor: 40, exp: 8, nivel: 1,
        bonus: { pesca: 1.1, durabilidad: 15 }
    },
    cana_oro: {
        id: 'cana_oro', nombre: 'Caña de Oro', emoji: '🏅', tipo: 'herramienta',
    ...
    arco_madera: {
        ...
        bonus: { caza: 1.2, durabilidad: 25, danio: 15 }
    },
    arco_hierro: {
        id: 'arco_hierro', nombre: 'Arco Reforzado', emoji: '🏹', tipo: 'arma',
        requiere: { madera: 25, hierro: 12, fibra: 20 }, valor: 200, exp: 35, nivel: 5,
        bonus: { caza: 1.5, durabilidad: 60, danio: 35 }
    },
    espada_hierro: {
        id: 'espada_hierro', nombre: 'Espada de Hierro', emoji: '⚔️', tipo: 'arma',
        requiere: { hierro: 15, madera: 10, piedra: 5 }, valor: 180, exp: 30, nivel: 4,
        bonus: { caza: 1.3, durabilidad: 50, danio: 30 }
    },
    espada_diamante: {
        id: 'espada_diamante', nombre: 'Espada de Diamante', emoji: '⚔️', tipo: 'arma',
        requiere: { diamante: 5, hierro: 10, madera_magica: 3 }, valor: 1500, exp: 100, nivel: 18,
        bonus: { caza: 2.0, durabilidad: 120, danio: 80 }
    },
    hacha_madera: {
        id: 'hacha_madera', nombre: 'Hacha de Madera', emoji: '🪓', tipo: 'herramienta',
        requiere: { madera: 15, piedra: 5 }, valor: 60, exp: 12, nivel: 1,
        bonus: { talar: 1.1, durabilidad: 20 }
    },
    hacha_hierro: {
        id: 'hacha_hierro', nombre: 'Hacha de Hierro', emoji: '🪓', tipo: 'herramienta',
        requiere: { madera: 20, hierro: 10, fibra: 10 }, valor: 180, exp: 30, nivel: 4,
        bonus: { talar: 1.4, durabilidad: 55 }
    },
    hacha_oro: {
        id: 'hacha_oro', nombre: 'Hacha de Oro', emoji: '🪓', tipo: 'herramienta',
        requiere: { madera: 25, oro: 8, fibra: 15 }, valor: 600, exp: 70, nivel: 10,
        bonus: { talar: 1.7, durabilidad: 90, luck: 1.2 }
    },
    casco_hierro: {
    ...
    peto_hierro: {
        id: 'peto_hierro', nombre: 'Peto de Hierro', emoji: '🛡️', tipo: 'armadura',
    ...
    pocion_vida: {
        id: 'pocion_vida', nombre: 'Poción de Vida', emoji: '🧪', tipo: 'consumible',
        requiere: { cristal: 3, fibra: 10, perla: 1 }, valor: 80, exp: 12, nivel: 4,
        efecto: { cura: 50, usos: 1 }
    },
    pocion_fuerza: {
        id: 'pocion_fuerza', nombre: 'Poción de Fuerza', emoji: '💪', tipo: 'consumible',
        requiere: { cristal: 5, ambar: 2, oro: 2 }, valor: 150, exp: 25, nivel: 8,
        efecto: { danio_bonus: 20, duracion: 300, usos: 1 }
    },
    cebo_magico: {
        id: 'cebo_magico', nombre: 'Cebo Mágico', emoji: '🪱', tipo: 'consumible',
        requiere: { perla: 2, resina: 1, fibra: 15 }, valor: 120, exp: 18, nivel: 6,
        efecto: { pesca_luck: 2.0, duracion: 600, usos: 3 }
    },
    anillo_oro: {
    ...
    corona_diamante: {
        ...
        bonus: { luck: 2.0, exp_bonus: 2.0, charisma: 50, mineria: 1.5, pesca: 1.5, caza: 1.5, talar: 1.5 }
    },
}
...
export const TIENDA_ITEMS = {
    ...
    pico_diamante: { ...RECETAS_CRAFTEO.pico_diamante, precio_compra: 3000, precio_venta: 1000 },
    hacha_madera: { ...RECETAS_CRAFTEO.hacha_madera, precio_compra: 90, precio_venta: 30 },
    hacha_hierro: { ...RECETAS_CRAFTEO.hacha_hierro, precio_compra: 300, precio_venta: 90 },
    hacha_oro: { ...RECETAS_CRAFTEO.hacha_oro, precio_compra: 1000, precio_venta: 300 },
    cana_basica: { ...RECETAS_CRAFTEO.cana_basica, precio_compra: 60, precio_venta: 20 },
    cana_oro: { ...RECETAS_CRAFTEO.cana_oro, precio_compra: 500, precio_venta: 150 },
    ...
    espada_diamante: { ...RECETAS_CRAFTEO.espada_diamante, precio_compra: 2500, precio_venta: 750 },
    casco_hierro: { ...RECETAS_CRAFTEO.casco_hierro, precio_compra: 180, precio_venta: 60 },
    peto_hierro: { ...RECETAS_CRAFTEO.peto_hierro, precio_compra: 400, precio_venta: 125 },
    botas_hierro: { ...RECETAS_CRAFTEO.botas_hierro, precio_compra: 150, precio_venta: 50 },
    pocion_vida: { ...RECETAS_CRAFTEO.pocion_vida, precio_compra: 120, precio_venta: 40 },
    pocion_fuerza: { ...RECETAS_CRAFTEO.pocion_fuerza, precio_compra: 250, precio_venta: 75 },
    cebo_magico: { ...RECETAS_CRAFTEO.cebo_magico, precio_compra: 200, precio_venta: 60 },
    anillo_oro: { ...RECETAS_CRAFTEO.anillo_oro, precio_compra: 1200, precio_venta: 400 },
    amuleto_esmeralda: { ...RECETAS_CRAFTEO.amuleto_esmeralda, precio_compra: 2500, precio_venta: 750 },
    corona_diamante: { ...RECETAS_CRAFTEO.corona_diamante, precio_compra: 15000, precio_venta: 5000 },
}
...
export function getItem(id) {
    return MINERALES[id] || PECES[id] || ANIMALES[id] || MATERIALES[id] || TIENDA_ITEMS[id] || RECETAS_CRAFTEO[id] || null
}
...
export function getItemsByCategory(categoria) {
    switch(categoria) {
        ...
        case 'talar': return Object.values(MATERIALES_TALAR)
        default: return []
    }
}
...
export function rollItem(itemsPool, luckBonus = 1) {
    ...
    const weightedPool = pool.map(item => ({
        ...item,
        effectiveProb: item.probabilidad * luckBonus
    }))
    const totalWeight = weightedPool.reduce((sum, item) => sum + item.effectiveProb, 0)
    let roll = Math.random() * totalWeight

    for (const item of weightedPool) {
        roll -= item.effectiveProb
