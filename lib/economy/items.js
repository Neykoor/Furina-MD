...
// FIX: TIENDA_ITEMS buscado ANTES que RECETAS_CRAFTEO para precios correctos
...
// FIX: rollItem con luckBonus correctamente aplicado
export function rollItem(itemsPool, luckBonus = 1) {
    const pool = Object.values(itemsPool)
    // Aplicar bonus multiplicando las probabilidades individuales
