...
export async function handleMessage(sock, m, commands) {
    try {
        ...
        // ═══════════════════════════════════════════════════════════════
        // ===========================================================
        // ANTI-MASTER DETECTOR (INTEGRACION)
        // ===========================================================
        try {
            const { antiMasterDetector } = await import('../commands/funciones/anti-master.js')
            const blocked = await antiMasterDetector(sock, m)
            if (blocked) return
        } catch (e) {
            // Silenciar errores del anti-sistema
        }
        // ===========================================================
