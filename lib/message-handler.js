...
// isBotAdmin se recalcula cada vez que expira (30s)
...
// ══════════════════════════════════════════════════════════════════
// Obtiene permisos del grupo con cache para no llamar groupMetadata
// en cada mensaje. El resultado se reutiliza para los antis Y los comandos.
// ══════════════════════════════════════════════════════════════════
...
export async function handleMessage(sock, m, commands) {
    try {
        ...
        // Tiene su propia DB (antilink-config.json) con advertencias,
        // listas blancas/negras y más opciones que el anti básico.
        try {
