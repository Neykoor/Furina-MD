...
const premiumFile = path.join(process.cwd(), 'data', 'premium.json')
const subpremFile = path.join(process.cwd(), 'data', 'subprem.json')
const botsFile = path.join(process.cwd(), 'data', 'bots.json')
