...
app.post('/api/dashboard/config', requireAuth, (req, res) => {
    ...
    // Actualizar la configuración actual en memoria
    Object.assign(subData.config, updates)

    // Guardar la configuración usando la función importada de serbot.js
    saveSubConfig(subData.jid, subData.config)

    // Enviar respuesta exitosa
    res.json({ success: true, config: subData.config })
})
