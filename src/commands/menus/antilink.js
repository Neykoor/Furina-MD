// menu-antilinks.js - Menú Antilinks
import fs from 'fs'
...
async function getLogoForZone(conn, zone, botConfig, isSubBot) {
    ...
    if (global.grupo) return global.grupo
...
┃ ⏳ *Próximamente...*
┃
┃ 🛡️ Los comandos antilinks estarán 
┃    disponibles muy pronto.
┃
╰━━━━━━━━━━━━━━━━━━╯`.trim()

    const logoUrl = await getLogoForZone(conn, 'antilinks', botConfig, isSubBot)
...
handler.help = ['antilinks']
handler.tags = ['grupo']
handler.command = ['antilinks', 'menuantilinks']
