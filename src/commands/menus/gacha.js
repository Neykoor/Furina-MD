...
async function getLogoForZone(conn, zone, botConfig, isSubBot) {
    ...
    if (global.gacha) return global.gacha
...
┃ ⏳ *Próximamente...*
┃
┃ 🎰 Los comandos de gacha estarán 
┃    disponibles muy pronto.
┃
╰━━━━━━━━━━━━━━━━━━╯`.trim()

    const logoUrl = await getLogoForZone(conn, 'gacha', botConfig, isSubBot)
...
handler.help = ['gacha']
handler.tags = ['gacha']
handler.command = ['gacha', 'menugacha']
