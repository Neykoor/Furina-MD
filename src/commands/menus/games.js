...
async function getLogoForZone(conn, zone, botConfig, isSubBot) {
    ...
    if (global.games) return global.games
...
┃ ⏳ *Próximamente...*
┃
┃ 🎮 Los comandos de juegos estarán 
┃    disponibles muy pronto.
┃
╰━━━━━━━━━━━━━━━━━━╯`.trim()

    const logoUrl = await getLogoForZone(conn, 'games', botConfig, isSubBot)
...
handler.help = ['games']
handler.tags = ['games']
handler.command = ['games', 'menugames']
